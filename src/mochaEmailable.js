 ...
 * @api public
 */
function MochaEmailable(runner, options) {
  ...
  runner.on('end', () => {
    try {
      ...
      if (!endCalled) {
        ...
        obj.stats.start = obj.stats.start.toISOString();
        obj.stats.end = obj.stats.end.toISOString();
